            ...
            if(m_creature->GetEntry() == ABOMINATION)
            {
                ...
                switch(OverrunType)
                {
                    ...
                    default:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[0][0]+irand(-3,3), AllianceOverrunWP[0][1]+irand(-3,3), AllianceOverrunWP[0][2]);
                        LastOverronPos = 17;
                        Start(true, true, true);
                        break;
                }
            ...
            if(m_creature->GetEntry() == GHOUL)
            {
                ...
                switch(OverrunType)
                {
                    ...
                    default:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[2][0]+irand(-10,10), AllianceOverrunWP[2][1]+irand(-10,10), AllianceOverrunWP[2][2]);
                        LastOverronPos = 20;
                        Start(true, true, true);
                        break;
                }
