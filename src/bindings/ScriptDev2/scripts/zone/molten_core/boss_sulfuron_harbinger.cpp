...
struct MANGOS_DLL_DECL boss_sulfuronAI : public ScriptedAI
{
    ...
    void Reset()
    {
		pInstance->SetData(DATA_SULFURON_PROGRESS, NOT_STARTED);
    ...
    void Aggro(Unit *who)
	{
		pInstance->SetData(DATA_SULFURON_PROGRESS, IN_PROGRESS);
	}

	void JustDied(Unit* Killer)
    {
		pInstance->SetData(DATA_SULFURON_PROGRESS, DONE);
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        {
            DoCast(m_creature->getVictim(),SPELL_HANDOFRAGNAROS);
