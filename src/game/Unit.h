...
class MANGOS_DLL_SPEC Unit : public WorldObject
{
    ...
    private:
        ...
        bool HandleModDamagePctTakenAuraProc(Unit *pVictim, uint32 damage, Aura* triggeredByAura, SpellEntry const *procSpell, uint32 procFlag, uint32 procEx, uint32 cooldown);
