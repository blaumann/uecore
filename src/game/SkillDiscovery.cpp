    ...
    if (result)
    {
        ...
        do
        {
            ...
            if(reqSkillOrSpell > 0)                         // spell case
            {
                ...
                {
                    sLog.outErrorDb("Spell (ID: %u) not have MECHANIC_DISCOVERY (28) value in Mechanic field in spell.dbc and not 100%% chance random discovery ability but listed in `skill_discovery_template` table",spellId);
                    continue;
                }
