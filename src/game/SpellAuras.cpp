...
void Aura::HandleAuraModShapeshift(bool apply, bool Real)
{
    ...
    if(apply)
    {
        ...
        if(PowerType != POWER_MANA)
        {
         ...
         //Master Shapeshifter(apply aura)
	     switch(form)
	     {
         case FORM_BEAR: 
         case FORM_DIREBEAR: 
         ...
         for(Unit::AuraList::const_iterator i = mDummy.begin(); i != mDummy.end(); ++i)
         {
	         ...
	         {
             case FORM_BEAR: 
             case FORM_DIREBEAR: spell_id = 48418; break;
             case FORM_CAT: spell_id = 48420; break;  
             case FORM_MOONKIN: spell_id = 48421; break;
             case FORM_TREE: spell_id = 48422; break;
			 }
		     }
		 if (spell_id)
         m_target->CastCustomSpell(m_target, spell_id, &bp, 0, 0, true);
		 }
		 break;
         }
	   }
    ...
    else
    {
		...
		//Master Shapeshifter(remove aura)
		switch(form)
		{
             case FORM_BEAR: 
             case FORM_DIREBEAR: m_target->RemoveAurasDueToSpell(48418); break;
             case FORM_CAT: m_target->RemoveAurasDueToSpell(48420); break;  
             case FORM_MOONKIN: m_target->RemoveAurasDueToSpell(48421); break;
             case FORM_TREE: m_target->RemoveAurasDueToSpell(48422); break;
		}
...
void Aura::HandleModPossess(bool apply, bool Real)
{
    ...
    if( apply )
    {
        ...
        else if(m_target->GetTypeId() == TYPEID_PLAYER && !m_target->GetVehicle())
        {
    ...
    else
    {
        ...
        if(m_target->GetTypeId() == TYPEID_PLAYER && !m_target->GetVehicle())
        {
