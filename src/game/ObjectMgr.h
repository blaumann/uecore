...
#define MIN_CREATURE_AI_TEXT_STRING_ID (-2)                 // 'creature_ai_texts'
#define MAX_CREATURE_AI_TEXT_STRING_ID (-2000000)
...
typedef std::map<uint64,uint64> CreatureVehiclesMap;        // TODO : needs implementation
