...
UPDATE `creature_template` SET `ScriptName`='npc_volkhans_anvil' WHERE `entry`='28823';
UPDATE `creature` SET `spawndist`=0,`MovementType`=0 WHERE `id`='28823';
...
-- * Optional * Below is mob status, use them wisely
UPDATE `creature_template` SET `minmana` = 20405, `maxmana` = 20405 WHERE `entry`='29240';
UPDATE `creature_template` SET `faction_A`=16, `faction_H`=16, `unit_flags`=33554434, `MovementType`=0, `InhabitType`=3 WHERE `entry`='28823'; -- change faction, don't move
UPDATE `creature_template` SET `minlevel` = 80, `maxlevel` = 80, `minhealth` = 34000, `maxhealth` = 34000, `faction_A`=16, `faction_H`=16 WHERE `entry`='28695';
UPDATE `creature_template` SET `minlevel` = 80, `maxlevel` = 80, `minhealth` = 42500, `maxhealth` = 42500, `faction_A`=16, `faction_H`=16 WHERE `entry`='30969'; -- heroic
UPDATE `creature_template` SET `minhealth` = 12600, `maxhealth` = 12600,`faction_A`=16, `faction_H`=16 WHERE `entry`='28926';
